...
public class ClassUnderTest {
	...
	public void addWalletWalletsManagerPage() {
		if (this.currentPage instanceof po.wallets.pages.WalletsManagerPage) {
			...
			if(page.filterComponent.getActiveFilter().equals("Active") && !page.accessComponent.getActiveAccessFilter().equals("Shared with you")
                || (page.accessComponent.getActiveAccessFilter().equals("Shared with you") && page.walletsListComponent.existWalletShared())){
	...
	public void editWalletWalletsManagerPage(custom_classes.Id id) {
		if (this.currentPage instanceof po.wallets.pages.WalletsManagerPage) {
			...
			if(page.walletsListComponent.isWalletPresent(id)
                && !page.walletsListComponent.isWalletShared(id)
                && page.filterComponent.getActiveFilter().equals("Active")
                && !page.accessComponent.getActiveAccessFilter().equals("Shared with you")){
