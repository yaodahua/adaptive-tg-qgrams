...
public class ClassUnderTestInstr {
    ...
    public void createNewSessionHomeContainerPage() {
        if (this.currentPage instanceof po.home.pages.HomeContainerPage) {
            ...
            this.currentPage = new po.retrospective.pages.RetrospectiveContainerPage(page.homeComponent.getDriver());
        } else {
    ...
    public void goToBoardHomeContainerPage(custom_classes.BoardNames boardName) {
        if (this.currentPage instanceof po.home.pages.HomeContainerPage) {
            ...
            if (page.tabComponent.isPreviousTabActive() && page.homeComponent.isBoardPresent(boardName.value())) {
                ...
                this.currentPage = new po.retrospective.pages.RetrospectiveContainerPage(page.tabComponent.getDriver());
            } else {
    ...
    public void goToPreviousViewHomeContainerPage() {
        if (this.currentPage instanceof po.home.pages.HomeContainerPage) {
            ...
            if (page.tabComponent.isPreviousTabPresent()) {
                ...
                this.currentPage = new po.home.pages.HomeContainerPage(page.tabComponent.getDriver());
            } else {
    ...
    public void logoutHomeContainerPage() {
        if (this.currentPage instanceof po.home.pages.HomeContainerPage) {
            ...
            this.currentPage = new po.login.pages.LoginContainerPage(page.homeComponent.getDriver());
        } else {
    ...
    public void leaveSessionMenuPage() {
        if (this.currentPage instanceof po.retrospective.pages.modals.MenuPage) {
            ...
            page.clickOn(org.openqa.selenium.By.xpath("((//body/div)[2]/div//button)[1]"));
            page.clickOutsideTheModal();
            this.currentPage = new po.home.pages.HomeContainerPage(page.getDriver());
        } else {
    ...
    public void logoutMenuPage() {
        if (this.currentPage instanceof po.retrospective.pages.modals.MenuPage) {
            ...
            page.clickOn(org.openqa.selenium.By.xpath("((//body/div)[2]/div//button)[2]"));
            page.clickOutsideTheModal();
            this.currentPage = new po.login.pages.LoginContainerPage(page.getDriver());
        } else {
    ...
    public void toggleSummaryModeMenuPage() {
        if (this.currentPage instanceof po.retrospective.pages.modals.MenuPage) {
            ...
            if (!page.isSummaryModeOn()) {
                logger.log(Level.INFO, "IF-143");
                page.clickOn(org.openqa.selenium.By.xpath("(//body/div)[2]/div//input[@label=\"Summary Mode\"]"));
                page.clickOutsideTheModal();
                this.currentPage = new po.retrospective.pages.RetrospectiveContainerPage(page.getDriver());
            } else {
    ...
    public void changeIdeasPostContentRetrospectiveContainerPage(custom_classes.Id id, custom_classes.IdeasPosts ideasPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            ...
            if (!page.retrospectiveComponent.isSummaryModeOn() && page.retrospectiveComponent.isIdeasPostPresent(id.value) && !page.retrospectiveComponent.isIdeasPostShared(id.value)) {
                ...
                this.currentPage = new po.retrospective.pages.RetrospectiveContainerPage(page.retrospectiveComponent.getDriver());
            } else {
    ...
    public void changeNotWentWellPostContentRetrospectiveContainerPage(custom_classes.Id id, custom_classes.NotWentWellPosts notWentWellPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void changeWentWellPostContentRetrospectiveContainerPage(custom_classes.Id id, custom_classes.WentWellPosts wentWellPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void createIdeasPostRetrospectiveContainerPage(custom_classes.IdeasPosts ideasPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            if (!page.retrospectiveComponent.isSummaryModeOn()) {
                logger.log(Level.INFO, "IF-256");
    ...
    public void createNotWentWellPostRetrospectiveContainerPage(custom_classes.NotWentWellPosts notWentWellPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            if (!page.retrospectiveComponent.isSummaryModeOn()) {
                logger.log(Level.INFO, "IF-276");
    ...
    public void createWentWellPostRetrospectiveContainerPage(custom_classes.WentWellPosts wentWellPost) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            if (!page.retrospectiveComponent.isSummaryModeOn()) {
                logger.log(Level.INFO, "IF-297");
    ...
    public void deleteNotWentWellPostRetrospectiveContainerPage(custom_classes.Id id) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            if (!page.retrospectiveComponent.isSummaryModeOn() && page.retrospectiveComponent.isNotWentWellPostPresent(id.value) && !page.retrospectiveComponent.isNotWentWellPostShared(id.value)) {
                logger.log(Level.INFO, "IF-341");
    ...
    public void deleteWentWellPostRetrospectiveContainerPage(custom_classes.Id id) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void dislikeNotWentWellPostRetrospectiveContainerPage(custom_classes.Id id) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void dislikeWentWellPostRetrospectiveContainerPage(custom_classes.Id id) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void likeNotWentWellPostRetrospectiveContainerPage(custom_classes.Id id) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            if (!page.retrospectiveComponent.isSummaryModeOn() && page.retrospectiveComponent.isNotWentWellPostPresent(id.value) && page.retrospectiveComponent.isNotWentWellPostShared(id.value) && page.retrospectiveComponent.isNotWentWellPostEnabled(id.value)) {
                logger.log(Level.INFO, "IF-490");
    ...
    public void openMenuRetrospectiveContainerPage() {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            logger.log(Level.INFO, "IF-529");
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;

            page.navbarComponent.clickOpenMenu();
            this.currentPage = new po.retrospective.pages.modals.MenuPage(page.navbarComponent.getDriver());
        } else {
    ...
    public void renameBoardRetrospectiveContainerPage(custom_classes.BoardNames newBoardName) {
        if (this.currentPage instanceof po.retrospective.pages.RetrospectiveContainerPage) {
            logger.log(Level.INFO, "IF-544");
            po.retrospective.pages.RetrospectiveContainerPage page = (po.retrospective.pages.RetrospectiveContainerPage) this.currentPage;
    ...
    public void loginLoginContainerPage(custom_classes.PeopleNames peopleName) {
        if (this.currentPage instanceof po.login.pages.LoginContainerPage) {
            ...
            if (page.loginComponent.waitForElementBeingPresentOnPage(org.openqa.selenium.By.xpath("//button[text()=\"Create a new session\"]"), timeout, java.util.concurrent.TimeUnit.MILLISECONDS)) {
                logger.log(Level.INFO, "IF-567");
                this.currentPage = new po.home.pages.HomeContainerPage(page.loginComponent.getDriver());
            } else {
                logger.log(Level.INFO, "IF-570");
                this.currentPage = new po.retrospective.pages.RetrospectiveContainerPage(page.loginComponent.getDriver());
            }
        } else {
